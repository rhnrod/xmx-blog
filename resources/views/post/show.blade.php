<x-layout>
    <x-slot>
        <!-- Novo Contêiner de Centralização e Limitação de Largura -->
        <div class="flex justify-center px-4 sm:px-6 md:px-8">
            <!-- max-w-4xl (aproximadamente 56rem ou 896px) é ideal para leitura de posts longos -->
            <div class="w-full max-w-4xl"> 
                ...
                <article class="bg-white p-6 sm:p-10 lg:p-12 rounded-2xl shadow-xl dark:bg-gray-800 dark:shadow-gray-700/50">
                    ...
                    <!-- Meta info (Autor, Views, Reações) -->
                    <div class="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 dark:text-gray-400 mb-6 border-b pb-4 dark:border-gray-700">
                        <!-- Autor -->
                        <div class="flex items-center">
                            <span class="font-medium mr-1">Por:</span>
                            <a href="{{ route('user.show', ['id' => $user['id']]) }}" class="hover:underline text-indigo-600 dark:text-indigo-400">
                    ...
                    <!-- Corpo do Post -->
                    <div class="post-body text-gray-700 dark:text-gray-300 text-lg leading-relaxed space-y-4">
                        <p>
                            {{ $post['body'] }}
                        </p>
                    </div>
                    ...
                    <!-- TAGS (Rodapé do Post) -->
                    <div class="mt-10 pt-4 border-t dark:border-gray-700">
                            ...
                            <div class="p-4 bg-gray-100 rounded-xl flex gap-x-4 dark:bg-gray-700">
                                ...
                                <div class="shrink-0">
                                   <img 
                                        ...
                                        onerror="this.onerror=null; this.src='https://placehold.co/48x48/6366f1/ffffff?text=C';"
                                    >
                                </div>
