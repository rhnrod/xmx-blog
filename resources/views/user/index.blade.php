    ...
    <x-slot class="dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            ...
            <div class="lg:col-span-2 space-y-8 md:space-y-10 order-2 lg:order-1">
                <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white mb-4 border-b pb-2 dark:border-gray-700">Posts de {{ $user['firstName'] }} {{ $user['lastName'] }}</h1>
